...
import br.com.beatriz.unittests.mocks.MockBook
...
class BookServiceTest {
   ...
   private lateinit var repository: BookRepository
    ...
    fun findAll() {
        ...
        println(bookSeven.links)
        assertTrue(bookSeven.links.toString().contains("/api/book/v1/7"))
